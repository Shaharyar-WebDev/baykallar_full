...
<x-admin.dashboard.dashboard-wrapper>
    ...
    <div class="grid md:grid-cols-3 lg:grid-cols-5 gap-2">
        ...
        href="{{ route('navbar.management') }}"
        description="Manage global navbar layouts and settings"
         icon='<svg xmlns="http://www.w3.org/2000/svg" class="size-9 transition-all" width="32" height="32"
