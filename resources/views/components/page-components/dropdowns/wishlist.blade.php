<x-page-components.tooltip-btn tooltip="Wishlist" class="hidden md:flex">
    <x-slot:button>
        <svg xmlns="http://www.w3.org/2000/svg" class="transition-all size-5" fill="currentColor" width="32" height="32"
